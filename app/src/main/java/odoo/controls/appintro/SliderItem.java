...
public class SliderItem {
    ...
    private int image = 0;
    private SliderPagerAdapter.SliderBuilderListener mSliderBuilderListener = null;
    private HashMap<String, Object> extras = new HashMap<>();

    public SliderItem(String title, String content, int image,
                      SliderPagerAdapter.SliderBuilderListener listener) {
        super();
    ...
    public void setSliderCustomViewListener(SliderPagerAdapter.SliderBuilderListener listener) {
        mSliderBuilderListener = listener;
    }
