...
public class OSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority,
        ...
        OdooUser mUser = OConstants.getUser();
        mModel = OModel.createInstance(mContext, mModelClass);
    ...
    private void syncData(OModel model, OdooUser user, ODomain domain_filter,
    ...
    private void handleRelationRecords(OdooUser user,
...
//            }
    ...
    public static Odoo createOdooInstance(final Context context, final OdooUser user) {
