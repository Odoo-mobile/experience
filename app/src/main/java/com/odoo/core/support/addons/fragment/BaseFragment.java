...
public abstract class BaseFragment extends Fragment implements IBaseFragment {
    ...
    public boolean destroyTabLayout = true;
    ...
    public View findViewById(@IdRes int res_id) {
        if (getView() != null)
            return getView().findViewById(res_id);
        return null;
    }
    ...
    public OdooUser user() {
        if (mContext != null)
            return OdooUser.current(mContext);
        return null;
    }
    ...
    public boolean _bool(int res_id) {
        return OResource.bool(mContext, res_id);
    }
    ...
    public void onResume() {
        super.onResume();
        if (OdooUser.current(getActivity()) == null)
            return;
