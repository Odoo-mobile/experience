...
public class BaseSettings extends PreferenceFragment {
    ...
    public static boolean showConferenceTime(Context context) {
        OPreferenceManager mPref = new OPreferenceManager(context);
        return mPref.getBoolean("show_event_time", false);
    }

    public static boolean notifyForSession(Context context) {
        OPreferenceManager mPref = new OPreferenceManager(context);
        return mPref.getBoolean("notify_for_session", true);
    }
