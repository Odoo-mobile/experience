...
import com.odoo.experience.core.api.odoo.client.helper.OdooResponse;
import com.odoo.experience.core.api.odoo.client.helper.data.OdooResult;
import com.odoo.experience.core.api.odoo.client.helper.utils.OArguments;
...
import com.odoo.experience.core.api.odoo.client.helper.utils.OdooValues;
import com.odoo.experience.core.api.odoo.client.helper.utils.ResponseQueue;
...
import com.odoo.experience.core.api.odoo.client.listeners.OdooVersionListener;
...
public abstract class ConnectorClient<T> implements Response.Listener<JSONObject>, Response.ErrorListener {
    ...
    public void getSessionInformation(IOdooResponse callback) {
        ...
        try {
            ...
            Log.v(TAG, "Session ERROR: " + e.getMessage());
        }
    }
